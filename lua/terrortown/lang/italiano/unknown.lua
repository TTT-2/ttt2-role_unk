...
L[UNKNOWN.name] = "Sconosciuto"
L["info_popup_" .. UNKNOWN.name] = [[Puoi decidere chi vuoi essere...
Fatti uccidere da qualcuno per prendere il suo ruolo!]]
L["body_found_" .. UNKNOWN.abbr] = "Era uno Sconosciuto..."
L["search_role_" .. UNKNOWN.abbr] = "Questa persona era uno Sconosciuto!"
L["target_" .. UNKNOWN.name] = "Sconosciuto"
L["ttt2_desc_" .. UNKNOWN.name] = [[Lo Sconosciuto può decidere (più o meno) il ruolo.
Fatti uccidere da qualcuno per prendere il suo ruolo!]]
